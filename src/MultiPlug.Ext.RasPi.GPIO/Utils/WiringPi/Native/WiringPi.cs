...
namespace MultiPlug.Ext.RasPi.GPIO.Utils.WiringPi.Native
{
    ...
    public partial class WiringPi
    {
        ...
        /// <summary>
        /// Added when Wiring Pi 3.18 was used in this project.
        /// </summary>
        /// <param name="pinType"></param>
        /// <returns></returns>
        [DllImport(WiringPiLibrary, EntryPoint = "wiringPiSetupPinType", SetLastError = true)]
        public static extern int WiringPiSetupPinType(int pinType);
        ...
        /// <returns></returns>
        [DllImport(WiringPiLibrary, EntryPoint = "wiringPiISR2", SetLastError = true)]
        public static extern int WiringPiISR2(int pin, int edgeMode, InterruptServiceRoutineCallbackV2 method, ulong debounce_period_us, IntPtr userdata );
        ...
        /// <param name="pin"></param>
        /// <returns></returns>
        [DllImport(WiringPiLibrary, EntryPoint = "wiringPiISRStop", SetLastError = true)]
        public static extern int WiringPiISRStop(int pin);
